...
public class EditNewsActivity extends AppCompatActivity implements Response,
    ...
    private EditText titleField, dateField, timeField, contentField;
    ...
    private void attemptPosting() {
        ...
        if (Internet.isConnected(this)) {
            basePresenter.editNews(newsId, title, dateTime, content, imagePath, videoPath, imageChanged, videoChanged);
        } else {
