...
import com.app.cnns_admin.view.activity.ReportDetailActivity;
...
public class ReporterListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ReporterListAdapter(List<News> news) {
        this.news = news;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (n.getStatus() == 0) {
            ...
            itemHolder.status.setTextColor(context.getResources().getColor(R.color.gray));
        } else {
