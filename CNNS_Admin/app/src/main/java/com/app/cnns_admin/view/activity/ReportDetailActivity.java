...
public class ReportDetailActivity extends AppCompatActivity implements Response {
    private Toolbar toolbar;
    private ScrollView mainLayout;
    private ImageView image;
    private TextView title, date, city, content;
    private TextView setStatus, views;
    ...
    private void setEvent() {
        ...
        views.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ReportDetailActivity.this, ViewerActivity.class);
        ...
        reporter.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ReportDetailActivity.this, ReporterActivity.class);
                intent.putExtra("news_id", newsId);
