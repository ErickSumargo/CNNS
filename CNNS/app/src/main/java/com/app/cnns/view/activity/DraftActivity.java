...
import com.app.cnns.view.adapter.DraftListAdapter;
import com.app.cnns.view.adapter.NewsListAdapter;

import java.util.ArrayList;
import java.util.List;

public class DraftActivity extends AppCompatActivity implements Response {
    ...
    private void initView() {
        ...
        draftListAdapter = new DraftListAdapter(new ArrayList<News>());
        newsListView.setAdapter(draftListAdapter);

        basePresenter = new BasePresenter(getApplicationContext(), this);
        basePresenter.loadDrafts();
    }
